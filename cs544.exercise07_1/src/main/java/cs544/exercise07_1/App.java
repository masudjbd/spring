...
public class App {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Query query = session.createQuery("select f from Flight f where f.origin.country = :coun and f.airplane.capacity > :cap");
            query.setParameter("coun", "USA");
        ...
        try {
            ...
            Query query = session.createQuery("SELECT f from Flight f WHERE f.airline.name != :name AND f.airplane.model=:model ");
        ...
        try {
            ...
            // TODO update HQL
            @SuppressWarnings("unchecked")
            Query query = session.createQuery("SELECT f from Flight f WHERE f.departureDate=:ddate AND f.departureTime < :dtime ");
            query.setParameter("ddate", new Date("08/07/2009"));
            query.setParameter("dtime", new Date("12:00:00"));
            List<Flight> flights = query.list();
